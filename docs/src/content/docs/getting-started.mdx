...
Various [examples](/examples/asides/) are provided to showcase how the theme will display content.
...
Refer to the [CHANGELOG](/changelog) for more information about specific changes.
:::
...
You can now further configure the theme and the graph component in the sidebar by following the [configuration](/configuration/graph/) guide.
